...
public class PacketRegistry {
    ...
    public void registerAll() {
      ...
      //  register(NetworkPhase.POST_ENCRYPTION, PacketDirection.SERVER_BOUND, 3, PlayerCreateC2SPacket.class, PlayerCreateC2SPacket.CODEC);
        register(NetworkPhase.POST_ENCRYPTION, PacketDirection.SERVER_BOUND, 4, PlayerDiscordConnectC2SPacket.class, PlayerDiscordConnectC2SPacket.CODEC);
//        register(NetworkPhase.POST_ENCRYPTION, PacketDirection.SERVER_BOUND, 5, SearchC2SPacket.class, SearchC2SPacket.CODEC);
   ...
   //     register(NetworkPhase.POST_ENCRYPTION, PacketDirection.SERVER_BOUND, 15, SetSourceC2SPacket.class, SetSourceC2SPacket.CODEC);
        ...
        register(NetworkPhase.POST_ENCRYPTION, PacketDirection.SERVER_BOUND, 18, ForceDiscordReconnectC2SPacket.class, ForceDiscordReconnectC2SPacket.CODEC);
        register(NetworkPhase.POST_ENCRYPTION, PacketDirection.SERVER_BOUND, 19, SeekC2SPacket.class, SeekC2SPacket.CODEC);
        ...
        register(NetworkPhase.POST_ENCRYPTION, PacketDirection.CLIENT_BOUND, 13, SearchResponseS2CPacket.class, SearchResponseS2CPacket.CODEC);
